...
<head>
  ...
  <title>Pricing • Ready Set Shows</title>

  <!-- Your existing CSS -->
  <link rel="stylesheet" href="<?= h(BASE_URL) ?>/assets/css/app.css">

  <style>
    /* Page-level styles matching your current dark/glow system */
    .page {
    ...
    @media (min-width: 980px) {
      ...
      .tier-card.wide { grid-column: span 6; }
    }

    @media (max-width: 720px) {
      .tier-card { grid-column: span 12; }
...
<body>
  ...
  <?php
    // Use your existing header/nav include if you have one:
  ...
  <main class="page">
    <div class="page-head">
      ...
      <div class="badge-current" title="This is just display language for now — no billing logic.">
